      ...
      <div className="h-full w-full mx-auto inline-flex items-center justify-between gap-1 mdl:gap-3 px-4">
        ...
        <div className="px-2 border border-transparent hover:border-white cursor-pointer duration-300 items-center justify-center h-[70%] hidden xl:inline-flex gap-1">
          ...
          <div className="text-xs">
            <p>Deliver to</p>
            <p className="text-white font-bold uppercase">Banglore</p>
          </div>
        </div>
        {/* serchbar */}
        ...
        {userInfo ? (
          ...
          <div
            onClick={() => signIn()}
            className="hidden md:flex text-xs text-gray-100 flex-col justify-center px-2 border border-transparent hover:border-white cursor-pointer duration-300 h-[70%]"
          >
            <p>Hello, sign in</p>
